...
PS_SetRepetitions(NStim, 10, 10) %Define a quantidade de vezes que a waveform ou pulso eh repetido
%NStim para o estimulador, ChN para o canal e NRep para numero de repeticoes (0 = inf)
PS_SetRepetitions(NStim, 2, 10) %Define a quantidade de vezes que a waveform ou pulso eh repetido
...
res = PS_LoadArbPattern(NStim, 10,'C:\Documents and Settings\Alunos\Desktop\pares_estimulos\grupo_1\gr1est1.pat'); %Esse caminho tem que ser redefinido para o caminho em que estiver o arquivo gr1est1.pat
res = PS_LoadArbPattern(NStim, 2, 'C:\Documents and Settings\Alunos\Desktop\pares_estimulos\grupo_1\gr1est2.pat'); %Esse caminho tem que ser redefinido para o caminho em que estiver o arquivo gr1est2.pat


res = PS_LoadAllChannels(NStim); %Carrega os parametros do canal ChN para o estimulador NStim
res = PS_StartStimChannel(NStim,10); %Inicia estimulacao no estimulador NStim e no canal ChN
res = PS_StartStimChannel(NStim,2); %Inicia estimulacao no estimulador NStim e no canal ChN
