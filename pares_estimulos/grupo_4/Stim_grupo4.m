...
res = PS_LoadArbPattern(NStim, 10, 'C:\Documents and Settings\Alunos\Desktop\pares_estimulos\grupo_4\gr4est1.pat'); %Esse caminho tem que ser redefinido para o caminho em que estiver o arquivo gr4est1.pat
res = PS_LoadArbPattern(NStim, 2, 'C:\Documents and Settings\Alunos\Desktop\pares_estimulos\grupo_4\gr4est2.pat'); %Esse caminho tem que ser redefinido para o caminho em que estiver o arquivo gr4est2.pat
