...
res = PS_LoadArbPattern(NStim, 10, 'C:\Documents and Settings\Alunos\Desktop\pares_estimulos\grupo_3\gr3est1.pat'); %Esse caminho tem que ser redefinido para o caminho em que estiver o arquivo gr3est1.pat
res = PS_LoadArbPattern(NStim, 2, 'C:\Documents and Settings\Alunos\Desktop\pares_estimulos\grupo_3\gr3est2.pat'); %Esse caminho tem que ser redefinido para o caminho em que estiver o arquivo gr3est2.pat
